...
export interface ApiCajaCaja extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    egresos: Schema.Attribute.Decimal;
    fechaApertura: Schema.Attribute.DateTime;
    fechaCierre: Schema.Attribute.DateTime;
    ingresos: Schema.Attribute.Decimal;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::caja.caja'> &
      Schema.Attribute.Private;
    montoFinal: Schema.Attribute.Decimal;
    montoInicial: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiInventarioInventario extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nombreIngrediente: Schema.Attribute.String;
    precioUnitario: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    unidad: Schema.Attribute.Enumeration<
      ['unidades', 'kg', 'paquetes', 'litros', 'libras']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiItemsVentaItemsVenta extends Struct.CollectionTypeSchema {
  collectionName: 'items_ventas';
  info: {
    displayName: 'ItemsVenta';
    pluralName: 'items-ventas';
    singularName: 'items-venta';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiUsuarioUsuario extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    nombre: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    rol: Schema.Attribute.Enumeration<['Administrador', 'Cajero', 'Cocinero']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::items-venta.items-venta': ApiItemsVentaItemsVenta;
